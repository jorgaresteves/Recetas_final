        ...
        <h1 class="our_text">Nuestras <span style="color: #161c1e;">favoritas</span></h1>
            <div class="recetas_sec_2">
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="img-fluid"><a href="{{ route('recetas.index') }}">
                        <img src="{{ asset('img/'. $recipe->name . '.jpg') }}" alt="{{ $recipe->name }}"></a>
                    </div>
                    </div>
                    </div>
                    @endif  
            ...
            <span class="fb_text "><a href="#" class="link">Home</span></a>
            </div>

            <div class="image-icon"><img src="{{ asset('img/bulit-icon.png') }}">
            <span class="fb_text "><a href="#" class="link">Recetas</span></a>
            </div>

            <div class="image-icon"><img src="{{ asset('img/bulit-icon.png') }}">
            <span class="fb_text "><a href="#" class="link">Ingredientes</span></a>
            </div>

            <div class="image-icon"><img src="{{ asset('img/bulit-icon.png') }}">
            <span class="fb_text "><a href="#" class="link">Contact Us</span></a>
            </div>
            </div>
            ...
            <span class="fb_text "><a href="#" class="link">Facebook</a></span>
            </div>
            <div class="image-icon"><img src="{{ asset('img/twitter-icon.png') }}">
            <span class="fb_text"><a href="#" class="link">Twitter</a></span>
            </div>
            <div class="image-icon"><img src="{{ asset('img/youtube-icon.png') }}">
            <span class="fb_text"><a href="#" class="link">Youtube</a></span>
            </div>
            <div class="image-icon"><img src="{{ asset('img/instagram-icon.png') }}">
            <span class="fb_text"><a href="#" class="link">Instagram</a></span>
            </div>
            </div>
